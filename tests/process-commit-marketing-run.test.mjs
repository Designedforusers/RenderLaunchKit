...
// the entire pipeline (DB, Voyage, Claude, the influencer discovery
// agent, the outreach draft agent, BullMQ) and is end-to-end testable
// only against live infrastructure. The CI smoke test confirms the
// module loads and exports the expected symbol.
