...
import { useProjectEvents } from '../hooks/useSSE.js';
import { StatusBadge } from './StatusBadge.js';
import { ProgressTimeline } from './ProgressTimeline.js';
import { StrategyBriefCard } from './StrategyBrief.js';
    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Strategy Brief */}
          {project.strategy && (
            <StrategyBriefCard strategy={project.strategy} />
          )}
            ...
            <div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {mediaAssets.map((asset) => (
                  <AssetCard key={asset.id} asset={asset} onRefresh={refresh} />
                ))}
              </div>
            </div>
          )}
        ...
        <div className="space-y-6">
          {/* Progress Timeline */}
          <ProgressTimeline status={project.status} events={events} />
