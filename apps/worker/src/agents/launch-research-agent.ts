...
import { runAgentLoop } from '../lib/anthropic-claude-client.js';
...
import { searchWeb, fetchUrl } from '../tools/web-research-tools.js';
...
export async function runResearchAgent(
  ...
  const result = await runAgentLoop({
    ...
    onToolCall: (name, input) => {
      projectProgressPublisher.toolCall(projectId, 'research', name, input);
