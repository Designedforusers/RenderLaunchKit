...
<!--
  ──────────────────────────────────────────────────────────────────────
  VENDORED FROM UPSTREAM — DO NOT HAND-EDIT.

  Source:  https://github.com/Pika-Labs/Pika-Skills
  Path:    pikastream-video-meeting/
  Commit:  9623c218173018bf9c892069941425387297a08d
  License: Apache-2.0 (see ./LICENSE and ./NOTICE)

  Refresh procedure: re-run the `curl` commands in `vendor/README.md`
  with the new upstream SHA, then update the Commit line above in the
  same PR so the provenance stays in lockstep with the file contents.
  ──────────────────────────────────────────────────────────────────────
-->
